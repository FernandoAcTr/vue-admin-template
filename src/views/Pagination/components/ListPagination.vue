<template>
  <q-card class="bg-transparent no-shadow no-border">
    ...
    <q-card-section>
      <q-item v-for="msg in listData" class="bg-white" :key="msg.id" clickable v-ripple>
...
const listData = computed(() => {
  return list_Data.slice((page.value - 1) * totalPages.value, page.value * totalPages.value)
})
</script>
