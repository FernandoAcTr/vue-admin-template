      ...
      <div class="col-3 rounded-borders q-px-xs">
        <q-card class="q-pa-xs custom_bg">
          ...
          <q-scroll-area
            ...
            ref="first"
          >
            <draggable class="list-group" v-model="planned_task">
              <template v-slot:item="{ item }">
                <q-card class="rounded-borders q-my-sm">
          ...
          >
            ...
            >
              <q-card
                ...
                @mouseleave="task_selected_index.wip = undefined"
              >
                <q-card-section class="row q-pa-sm">
                  <div class="col-12">
                    <span class="text-weight-bold text-h6 q-ml-sm">{{ item.title }}</span>
          ...
          >
            ...
            >
              <q-card
                ...
                @mouseleave="task_selected_index.blocked = undefined"
              >
                <q-card-section class="row q-pa-sm">
                  <div class="col-12">
                    <span class="text-weight-bold text-h6 q-ml-sm">{{ item.title }}</span>
          ...
          >
            ...
            >
              <q-card
                ...
                @mouseleave="task_selected_index.completed = undefined"
              >
                <q-card-section class="row q-pa-sm">
                  <div class="col-12">
                    <span class="text-weight-bold text-h6 q-ml-sm">{{ item.title }}</span>
...
<script lang="ts" setup>
  ...
  const task_selected_index = reactive<{
    planned?: number
    wip?: number
    blocked?: number
    completed?: number
  ...
  function onResize(size_dynamic: any) {
  ...
  function getHeight() {
    return Number(size.value.height) - 90 + 'px'
  }
</script>
